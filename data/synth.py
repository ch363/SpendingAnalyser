...
SUBSCRIPTION_MERCHANTS: Sequence[Tuple[MerchantProfile, float]] = (
    ...
    (
        MerchantProfile(
            description="DIRECT DEBIT DISNEY PLUS UK",
            mcc="4899",
            category="subscriptions",
            channel="direct_debit",
            city="London",
    ...
    (
        MerchantProfile(
            description="DIRECT DEBIT AMAZON PRIME",
            mcc="4899",
            category="subscriptions",
            channel="direct_debit",
            city="London",
            country="GBR",
            default_note="Prime membership",
        ),
        -8.99,
    ),
    (
        MerchantProfile(
            description="DIRECT DEBIT YOUTUBE PREMIUM",
            mcc="4899",
            category="subscriptions",
            channel="direct_debit",
            city="London",
            country="GBR",
            default_note="Ad-free YouTube",
        ),
        -11.99,
    ),
    (
        MerchantProfile(
            description="DIRECT DEBIT MICROSOFT 365",
            mcc="5734",
            category="subscriptions",
            channel="direct_debit",
            city="Reading",
            country="GBR",
            default_note="Productivity suite",
        ),
        -7.99,
    ),
    (
        MerchantProfile(
            description="DIRECT DEBIT APPLE ICLOUD",
            mcc="4816",
            category="subscriptions",
            channel="direct_debit",
            city="London",
            country="GBR",
            default_note="Cloud storage",
        ),
        -2.49,
    ),
    (
        MerchantProfile(
            description="DIRECT DEBIT DROPBOX",
            mcc="5734",
            category="subscriptions",
            channel="direct_debit",
            city="London",
    ...
    (
        MerchantProfile(
            description="DIRECT DEBIT ADOBE CC",
            mcc="5734",
            category="subscriptions",
            channel="direct_debit",
            city="London",
            country="GBR",
            default_note="Creative Cloud",
        ),
        -19.99,
    ),
    (
        MerchantProfile(
            description="DIRECT DEBIT AUDIBLE UK",
            mcc="4899",
            category="subscriptions",
            channel="direct_debit",
            city="London",
            country="GBR",
            default_note="Audiobooks",
        ),
        -7.99,
    ),
    (
        MerchantProfile(
            description="DIRECT DEBIT HEADSPACE",
            mcc="8099",
            category="subscriptions",
            channel="direct_debit",
            city="Manchester",
            country="GBR",
            default_note="Meditation app",
        ),
        -4.99,
    ),
)
...
def generate_synthetic_transactions(
    ...
    *,
    ...
    # control discretionary daily transaction targets (inclusive)
    min_daily_txns: int = 6,
    max_daily_txns: int = 8,
    # if True, prefer card channels (card_present/online) when counting daily transactions
